...
const (
	RatingService_SubmitRating_FullMethodName     = "/hipstershop.RatingService/SubmitRating"
	RatingService_GetProductRating_FullMethodName = "/hipstershop.RatingService/GetProductRating"
	RatingService_GetUserRating_FullMethodName    = "/hipstershop.RatingService/GetUserRating"
)
...
func (c *ratingServiceClient) GetProductRating(ctx context.Context, in *GetProductRatingRequest, opts ...grpc.CallOption) (*GetProductRatingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProductRatingResponse)
	err := c.cc.Invoke(ctx, RatingService_GetProductRating_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRatingServiceServer) GetProductRating(context.Context, *GetProductRatingRequest) (*GetProductRatingResponse, error) {
...
func _RatingService_GetProductRating_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProductRatingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RatingServiceServer).GetProductRating(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RatingService_GetProductRating_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatingServiceServer).GetProductRating(ctx, req.(*GetProductRatingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RatingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.RatingService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RatingService_GetProductRating_Handler,
		},
		{
